...
function disableNewArrayBtn(){
    document.querySelector("#generate_array_random").disabled = true;
}

// Enables newArray buttons used in conjunction with disable
function enableNewArrayBtn(){
    document.querySelector("#generate_array_random").disabled = false;
}
...
let arraySize = document.querySelector('#array-size-slider');
...
const newArray = document.querySelector("#generate_array_random");
